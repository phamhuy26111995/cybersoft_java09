                ...
                <table class="table table-bordered table-hover mt-3">
                    ...
                    <tbody>
                     <c:forEach var="item" items="${dtos}">
                     	  ...
                     	  <tr>
                            <td>${item.id}</td>
                            <td><a href="${contextPath}/vocabulary?cate=${item.id}">${item.name}</a></td>
                            <td>
                                <a href="${contextPath}/category/edit?id=${item.id}" class="btn btn-sm btn-info">
                                    <i class="fa fa-pencil-square-o"></i>
                                </a>
                                <a href="${contextPath}/category/${item.id}" class="btn btn-sm btn-danger">
