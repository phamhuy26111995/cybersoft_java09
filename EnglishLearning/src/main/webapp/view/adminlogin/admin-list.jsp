    ...
    <div class="d-flex justify-content-between">
        ...
        <div id="admin-wrapper">
            ...
            <section id="admin-content" class="p-3">
                <h3 class="mb-3">Danh sách User</h3>
                <div class="row">
                    <div class="col-md-8">
                    ...
                    <tbody>
                     <c:forEach var="item" items="${dtos}">
                     	  ...
                     	  <tr>
                            ...
                            <td>${item.roleName}</td>
                            <td>
                                <a href="${contextPath}/admin/user/edit?id=${item.id}" class="btn btn-sm btn-info">
                                    <i class="fa fa-pencil-square-o"></i>
                                </a>
                                <a href="${contextPath}/admin/user/${item.id}" class="btn btn-sm btn-danger">
