        ...
        <div id="admin-wrapper">
            ...
            <section id="admin-content" class="p-3">
                ...
                <div class="btn_options">
                	<div class="btn_english"><a href="${contextPath}/exam/vocabulary/english-vietnam?${cate}">Anh - Việt</a></div>
                	<div class="btn_vietnamese"><a href="${contextPath}/exam/vocabulary/vietnam-english?${cate}">Việt - Anh</a></div>
                </div>
