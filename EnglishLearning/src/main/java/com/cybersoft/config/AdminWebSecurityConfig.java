...
public class AdminWebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable();
		http.authorizeRequests().antMatchers("/login/**").permitAll().anyRequest().hasRole("ADMIN").and()
        ...
        .defaultSuccessUrl("/admin/").failureUrl("/login/admin?error=fail")//
       
        .usernameParameter("j_username_admin")//
        .passwordParameter("j_password_admin")
