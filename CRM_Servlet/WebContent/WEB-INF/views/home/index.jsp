...
<% String contextPath = request.getContextPath() ;%>
 ...
 <meta charset="utf-8">
    ...
    <!-- toast CSS -->
    <link href="<%=contextPath %>/static/plugins/bower_components/toast-master/css/jquery.toast.css" rel="stylesheet">
    <!-- morris CSS -->
    <link href="<%=contextPath %>/static/plugins/bower_components/morrisjs/morris.css" rel="stylesheet">
    <!-- animation CSS -->
...
<body>
    ...
    <!--Counter js -->
    <script src="<%=contextPath %>/static/plugins/bower_components/waypoints/lib/jquery.waypoints.js"></script>
    <script src="<%=contextPath %>/static/plugins/bower_components/counterup/jquery.counterup.min.js"></script>
    <!--Morris JavaScript -->
    <script src="<%=contextPath %>/static/plugins/bower_components/raphael/raphael-min.js"></script>
    <script src="<%=contextPath %>/static/plugins/bower_components/morrisjs/morris.js"></script>
    <!-- Custom Theme JavaScript -->
    <script src="<%=contextPath %>/static/js/custom.min.js"></script>
    <script src="<%=contextPath %>/static/js/dashboard1.js"></script>
    <script src="<%=contextPath %>/static/plugins/bower_components/toast-master/js/jquery.toast.js"></script>
</body>
